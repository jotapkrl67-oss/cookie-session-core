    ...
    async def send(
        ...
        **kwargs: Any,
        ...
        for attempt in range(max_attempts):
            ...
            mitigated_hdr = (
                str(getattr(resp.headers, "get", lambda _k: "")("cf-mitigated") or "").lower()
            )
            ...
            should_solve = (
                is_challenge
                or is_managed_challenge
                or (is_cf_429 and solver is not None and attempt >= 1)
            )
