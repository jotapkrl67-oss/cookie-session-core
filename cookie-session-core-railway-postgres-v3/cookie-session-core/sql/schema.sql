...
ALTER TABLE cookie_core_profiles ENABLE ROW LEVEL SECURITY;
...
BEGIN
  IF EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'anon') THEN
    REVOKE ALL ON cookie_core_services, cookie_core_profiles,
      cookie_core_stored_cookies, cookie_core_launch_tokens,
